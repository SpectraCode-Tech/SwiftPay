...
import image from '../assets/featimg.png'

const Features = () => {
  return (
    <div className='py-10 px-5 text-center text-white bg-dark-green'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 px-5 lg:grid-cols-4 gap-8 mt-8 *:transition-all *:ease-in-out *:duration-300 *:rounded *:bg-green *:p-5">
        <span className='hover:-translate-y-2 cursor-pointer w-72'>
